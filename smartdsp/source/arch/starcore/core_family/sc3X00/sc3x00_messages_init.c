...
/******************************************************************************
 ...
 $Id: sc3x00_messages_init.c,v 1.9 2012/11/22 16:28:51 sw Exp $
 $Source: /cvsdata/SmartDSP/source/arch/starcore/core_family/sc3X00/sc3x00_messages_init.c,v $
 $Revision: 1.9 $
******************************************************************************/

/******************************************************************************
 
 @File          sc3x00_messages_init.c
...
#define MSG_INT_NUM(src_core, msg_num) (OS_INT_FROM_CORE0_0 + (SOC_MAX_NUM_OF_MESSAGES * src_core) + msg_num)
...
os_status osMessageInitialize(uint16_t num_of_messages)
{
    ...
    if (num_of_messages > SOC_MAX_NUM_OF_MESSAGES)
    {
                          ...
                          os_hwi_function   msg_handler)
{
    ...
    for (src_core=0 ; src_core<SOC_MAX_NUM_OF_CORES ; src_core++)
    {
