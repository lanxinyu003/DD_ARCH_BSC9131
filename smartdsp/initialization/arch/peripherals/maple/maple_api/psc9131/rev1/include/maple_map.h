...
/** FTPE Context                               - 0xd800 to  0xd900. Size - 0x100 bytes **/
...
#define TVPE_EXTRINSIC_BASE_ADDR          0x20000
#define TVPE_EXTL_BASE_ADDR               0x40000
...
#define TVPE_HEO1_BASE_ADDR               0x72000
#define TVPE_HOO1_BASE_ADDR               0x72400
#define TVPE_HEO2_BASE_ADDR               0x72800
#define TVPE_HOO2_BASE_ADDR               0x72c00
#define TVPE_HO_BASE_ADDR                 0x73000
...
#define CRPEULB_INPUT_BUFFER0_BASE_ADDR       CRPEULB_BASE_ADDR
#define CRPEULB_INPUT_BUFFER1_BASE_ADDR       (CRPEULB_BASE_ADDR + 0x2000)
#define CRPEULB_INPUT_BUFFER2_BASE_ADDR       (CRPEULB_BASE_ADDR + 0x4000)
#define CRPEULB_OUTPUT_BUFFER_BASE_ADDR      (CRPEULB_BASE_ADDR + 0x8000)
#define CRPEULB_PCH_COMMAND_BASE_ADDR         (CRPEULB_BASE_ADDR + 0x10000)
...
#define CRPEULBSTARTFCBI_OPCODE         0x13
#define DMA_CLOSE_OPEN_ACC_OPCODE       0x19
#define DMA_SLAVE_READ                  0x1b
...
#define CRPE_ULB_NUM_OF_GROUP 6
#define CRPE_ULB_NUM_OF_PCH 112
#define CRPE_ULB_NUM_OF_ANT 12
#define CRPE_ULB_NUM_OF_IBS 2
#define CRPE_ULB_SIZE_OF_FCB  112
#define CRPE_CRDL_SLOT_CHANNELS_NUM     81
#define CRPE_CRDL_SUB_SLOT_CHANNELS_NUM 50
#define CRPE_CRDL_MAX_ANTENNA           3
...
typedef struct MaplePRAM {
    ...
    /** Reserved 4                                                      - 0x38 to 0x3f **/
    unsigned char      ucReserved4[8];
   ...
   /** Maple HARQ DMA Write Split  size                                      - 0x580 **/
    unsigned long int uliHARQWRSplitSize;
    /** Maple HARQ DMA Read Split size                                      - 0x584 **/
    unsigned long int uliHARQRDSplitSize;
    /** Reserved 1                                                                        - 0x588 to 0x59f **/
    unsigned char      ucReserve1[24];
    ...
    /** Reserved 3                                                        - 0x698 to 0x6ff **/
    unsigned char      ucReserve3[104];
    ...
    unsigned char      ucReserved8[224];
    /** Slave DMA size                                                    - 0x7f0 to 0x7f3 **/
    unsigned int       uliSlaveDMASize;
    /** Slave DMA read address                                            - 0x7f4 to 0x7f7 **/
    unsigned int       uliSlaveDMAWriteAddress;
    /** Slave DMA write address                                           - 0x7f8 to 0x7fb **/
    unsigned int       uliSlaveDMAReadAddress;
    /** flag to mark end of init omrMapleInit  - internal use only        - 0x7fc  **/
...
typedef struct CRPEULB {
    ...
    MAPLERESERVED(0x414,0x418);
    /** CRPE 1xRTT Long Code State Control Register 0x1F418 - 0x1F41F **/
    unsigned long long int ulliCRUB1xLLR;
    MAPLERESERVED(0x420,0x800);
...
typedef struct CRPEULF {
    /** General Configuration Register #0  0x0    **/
    unsigned int      uliULFGCR;
    MAPLERESERVED(0x4,0x80);
    /** Interpolation Configuration Register #x  0x80 to 0x87   **/
    unsigned int      auliULFICRx[4] ;
	MAPLERESERVED(0x90,0x100);
    /** Output Buffer #x Base Configuration & Attributes Configuration  Register  0x100 to 0x12f   **/
    unsigned int      auliULFOB0BCRx[6][2];
	MAPLERESERVED(0x130,0x200);
    /** Pseudo Reset Control Register  0x200    **/
    unsigned int      uliULFPRLR;
	MAPLERESERVED(0x204,0x280);
    /** Event Status Register  0x280    **/
    unsigned int      uliULFESR;
	MAPLERESERVED(0x284,0x290);
    /** CommandsFIFO Status Register  0x290    **/
...
typedef struct CRPEDL_channel_vags{
   t_CRPEDL_channel_vag CRPEDL_channel_vag[80];
...
typedef struct CGPEBD_2K {
     /** OWNER/WRAP/INT_EN/MB_PR/NUM_OF_MASKS 0x0**/
     unsigned short int usiCtrl1;
     /** CODE_LENGTH/INIT_STATE_SEL 0x2*/
     unsigned short int usiCtrl2;
     /** MASK_PTR 0x4*/
     unsigned int uliMask_pointer;
     /** CODE_RSLT_PTR 0x8*/
     unsigned int uliRSLT_PTR;
     /** TASK_ID/LONG_INIT_STATE 0xc*/
     unsigned int uliCtrl3;
     /** LONG_INIT_STATE continue 0x10*/
     unsigned int uliCtrl4;
     /** LONG_LAST_STATE/ 0x14*/
     unsigned int uliLastState;
     /** LONG_LAST_STATE/ 0x18*/
     unsigned short int usiLastState;
     /** LONG_NEXT_STATE 0x1a*/
     unsigned short int usiNextState;
     /** LONG_NEXT_STATE 0x1c*/
     unsigned int uliNextState;
} t_CGPEBD_2K;
...
typedef struct CRPEDLParam {
    ...
    MAPLERESERVED(0x830, 0x2000);
    /** antennas BA, SZ, WRPTR   - 0x2000 **/
