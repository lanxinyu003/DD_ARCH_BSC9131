...
void maple_init(maple_dev_init_params_t *maple_param)
{
   ...
   MAPLEWRITE32(maple_mmc1p_parameter,maple_param->mode1|0x10); // set also ecc enable bit in parameter
   ...
   maple_sdmr = ((data>>24)&0x3)|((data>>14)&0x30);
   ...
   MAPLEWRITE32(&pstPRAM->uliMUCVP,0x407);
   ...
   if (maple_param->pusch_mode & 0x80000000)
   {
   ...
   // timer period should be at least 9
