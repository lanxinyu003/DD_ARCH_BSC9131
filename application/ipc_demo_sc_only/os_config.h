...
/******************************************************************************
 ...
 $Id: os_config.h,v 1.6 2012/11/22 16:27:45 sw Exp $
 $Source: /cvsdata/SmartDSP/demos/starcore/psc9x3x/ipc_demo_sc_only/os_config.h,v $
 $Revision: 1.6 $
******************************************************************************/
...
#if (OS_MULTICORE == ON)
#define OS_SHARED_MEM_SIZE                  0x1000   /**< Shared Memory Size */
#endif
...
#define OS_HEAP_DDR1_NOCACHEABLE_SIZE       0x1000
#if (OS_MULTICORE == ON)
